...
public class ExchangeRatesYesterdayTrendPositiveCondition {

    public static void setupMockBooksResponse(WireMockServer mockService) throws IOException {
        mockService.stubFor(WireMock.get(WireMock.urlEqualTo("/api/historical/2020-01-01.json?app_id=1c7d2da6c50d45f581e57d49856e5a2e&%7Bparams%7D&base=USD"))
